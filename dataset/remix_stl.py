...
def get_cifar10(root, l_samples, method = 'remix', transform_train=transform_train, transform_strong=transform_strong,
    ...
    if method == 'remix':
        train_labeled_dataset = CIFAR10_labeled(root, train_labeled_idxs, split='train', transform=transform_strong)
    else:
        train_labeled_dataset = CIFAR10_labeled(root, train_labeled_idxs, split='train', transform=transform_train)

    ##### Unlabeled data
    if method == 'mix':
        train_unlabeled_dataset = CIFAR10_unlabeled(root, indexs=None, split='unlabeled',
    ...
    test_dataset = CIFAR10_labeled(root, split='test', transform=transform_val, download=False)
